...
export const autoSyncNote =
  "mx-0 mt-0 mb-5 flex items-center gap-[7px] text-[12px] text-[var(--muted)] before:h-[5px] before:w-[5px] before:shrink-0 before:rounded-full before:bg-[var(--success)] before:content-[''] has-[.skeleton-sync-note]:before:hidden [@media(max-width:480px)]:text-[11px] [@media(max-width:480px)]:leading-[1.6]";
